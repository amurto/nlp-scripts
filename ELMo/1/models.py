...
from utils import get_score_senti,get_score_senti2
...
class SentimentModel(object):
    ...
    def score2(self,input_data):
        input_pad2 = self.prepare_input(input_data)
        prediction2 = self.model.predict(input_pad2)
        get_score_senti2(prediction2)
