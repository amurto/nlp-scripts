...
def pre_process(file_folder, word_cut_func, is_en):
    ...
    train_data = pd.read_csv(os.path.join(file_folder, 'train.csv'), header=0, index_col=None,encoding = 'unicode_escape')
    ...
    valid_data = pd.read_csv(os.path.join(file_folder, 'valid.csv'), header=0, index_col=None,encoding = 'unicode_escape')
    ...
    test_data = pd.read_csv(os.path.join(file_folder, 'test.csv'), header=0, index_col=None,encoding = 'unicode_escape')
    ...
    word_corpus = np.concatenate((train_data['word_list'].values, valid_data['word_list'].values, test_data['word_list'].values)).tolist()
    char_corpus = np.concatenate((train_data['char_list'].values, valid_data['char_list'].values,test_data['char_list'].values)).tolist()
